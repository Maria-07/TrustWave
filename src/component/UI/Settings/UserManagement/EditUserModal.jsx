...
const EditUserModal = ({ handleClose, clicked, record }) => {
  const {
    register,
    handleSubmit,
    formState: { errors },
        ...
        <div className="">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 my-3 mr-2 gap-x-2 gap-y-3">
              ...
              <div className="">
                <label className="label flex items-center">
                  <div className="modal-label-name">Actual Name</div>
                </label>
                <input
                  // defaultValue={}
                  type="text"
              ...
              <div className="">
                <label className="label flex items-center">
                  <div className="modal-label-name">Email ID</div>
                </label>
                <input
                  // defaultValue={}
                  type="text"
              ...
              <div className="">
                <label className="label flex items-center">
                  <div className="modal-label-name">A/C Status</div>
                </label>
                <select
                  className="modal-input-field ml-1 w-full"
                  {...register("gender")}
              ...
              <div className="">
                <label className="label flex items-center">
                  <div className="modal-label-name">A/C Type</div>
                </label>
                <select
                  className="modal-input-field ml-1 w-full"
                  {...register("gender")}
