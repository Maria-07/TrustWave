...
const EditContractStatusModal = ({ handleClose, clicked, record }) => {
  const {
    register,
    handleSubmit,
    formState: { errors },
            ...
            <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 my-3 mr-2 gap-x-2 gap-y-3">
              <div className="">
                <label className="label flex items-center">
                  <div className="modal-label-name">Contract Status Name *</div>{" "}
                </label>
                <input
                  type="text"
                  name="clear_type"
              ...
              <div className="">
                <label className="label flex items-center">
                  <div className="modal-label-name">Status Group </div>
                </label>
                <select
                  className="modal-input-field ml-1 w-full"
                  {...register("gender")}
              ...
              <div className="">
                <label className="label flex items-center">
                  <div className="modal-label-name">Is Show Reminder *</div>
                </label>
                <select
                  className="modal-input-field ml-1 w-full"
                  {...register("gender")}
              ...
              <div className="">
                <label className="label flex items-center">
                  <div className="modal-label-name">Restrict</div>
                </label>
                <select
                  className="modal-input-field ml-1 w-full"
                  {...register("gender")}
...
export default EditContractStatusModal;
